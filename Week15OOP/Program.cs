...
{
    Console.WriteLine($"One of my favourite movies {movie.title} was released {movie.year}.");
}

foreach (Movie movie in list)
{
    Console.WriteLine($"One of my favourite movies {movie.title} has a {movie.rating} rating.");
}
